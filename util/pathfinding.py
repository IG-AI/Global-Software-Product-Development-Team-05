...
class SquareGrid:
    ...
    def options(self, id):
        ...
        if xDir == 1 and yDir == 0:
            ...
            results = [((x + 1, y, xDir, yDir), costForward), ((x - 1, y, xDir, yDir), costBackward),
                       ((x, y, 0, 1), costTurn), ((x, y, 0, -1), costTurn)]
            ...
            # forward, backward, turn right, turn left
            results = [((x, y - 1, xDir, yDir), costForward), ((x, y + 1, xDir, yDir), costBackward),
                       ((x, y, 1, 0), costTurn), ((x, y, -1, 0), costTurn)]
